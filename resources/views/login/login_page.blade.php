                    ...
                    <div id="loginBox">
                        ...
                        <div>
                            <form action="authenticate/login_process.php" method="POST" id="signin-form">
                                <div>
                                    <label style="margin-right:40px; border-radius:7px; background-color: #218AD1; color:white; padding:10px">Employee <input type="radio" name="usertype" value="employee" checked="checked" required></label>
                                    <label style="border-radius:7px; background-color: #218AD1; color:white; padding:10px">Student <input type="radio" name="usertype" value="student" required></label>
                                </div>
                                ...
                                <p>{{ isset($_COOKIE["error"]) ? $_COOKIE["error"] : ''}}</p>
