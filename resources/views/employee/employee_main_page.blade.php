        ...
        <div class="row">
            <div class="col-sm-2 side-bar">
                ...
                <div class="side-list">
                    ...
                    <div>
                        <button onclick="window.location.href='employee-main'" id="active-button"><div><img alt="Image not found" src="storage/images/icons/home-icon-active.svg"></div><div style="margin-left: 10px;">Home Page</div></button>
