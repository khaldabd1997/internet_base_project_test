            ...
            <div class="col-sm-2 side-bar">
                ...
                <div class="side-list">
                    ...
                    <div>
                        ...
                        <button onclick="window.location.href='employee-messages'" id="active-button"><div><img alt="Image not found" src="storage/images/icons/mail-icon-active.svg"></div><div style="margin-left: 10px;">Messages</div></button>
                    </div>
                </div>
            </div>
