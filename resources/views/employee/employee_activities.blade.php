            ...
            <div class="col-sm-2 side-bar">
                ...
                <div class="side-list">
                    ...
                    <div>
                        ...
                        <button onclick="window.location.href='employee-activities'" id="active-button"><div><img alt="Image not found" src="storage/images/icons/activities-icon-active.svg"></div><div style="margin-left: 10px;">Activities</div></button>
