            ...
            <div class="col-sm-2 side-bar">
                ...
                <div class="side-list">
                    ...
                    <div>
                        ...
                        <button onclick="window.location.href='student-info'" id="active-button"><div><img alt="Image not found" src="storage/images/icons/statistic-icon-active.svg"></div><div style="margin-left: 10px;">Personal Infos</div></button>
